...
>
	...
	<div slot="content">
		<div
			class="w-70 px-1 py-1 border border-gray-400 dark:border-gray-800 z-50 bg-white dark:bg-gray-850 dark:text-white shadow-lg max-h-72 overflow-y-auto overflow-x-hidden scrollbar-thin transition"
		>
			{#if tab === ''}
